...
main = tkinter.Tk()
main.title("Abnormal Events Detection and tracking in Surveillance System")
...
font = ('times', 20, 'bold')
title = Label(main, text='Abnormal Events Detection and tracking in Surveillance System')
